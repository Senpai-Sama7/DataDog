...
class TestPipeline:
    ...
    def test_add_transformation(self) -> None:
        ...
        transform = Transformation(
            name="filter_data", function_name="filter_nulls", parameters={"columns": ["id", "name"]}
        )
    ...
    def test_build_dag(self) -> None:
        ...
        transform = Transformation(
            name="transform", function_name="filter_nulls", parameters={"columns": ["id"]}
        )
        pipeline.add_transformation(transform)
...
class TestTask:
    ...
    def test_task_creation(self) -> None:
        ...
        task = Task(name="test_task", task_type="source", dependencies=[])
    ...
    def test_task_with_dependencies(self) -> None:
        ...
        task2 = Task(name="task2", task_type="transformation", dependencies=[task1.task_id])
